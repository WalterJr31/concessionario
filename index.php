...
<body>
    ...
    <main>
        ...
        <div class="row">
            <div class="col">
                <h2 class="display6 text-center" id="carros">CARROS</h2>
            </div>
        </div>
        <div class="container mt-5">
            <div class="row">
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="img/carro01.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title text-danger">Venda de Carros</h5>
                            <p class="card-text">No nosso site você encontra os melhores carros do ano.</p>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="img/carro02.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="img/carro03.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title text-warning">Venda de Carros</h5>
                            <p class="card-text">No nosso site você encontra os melhores carros do ano.</p>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="img/carro04.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title text-danger">Venda de Carros</h5>
                            <p class="card-text">No nosso site você encontra os melhores carros do ano.</p>
                            <a href="#" class="btn btn-danger btn-lg">Compre já</a>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;">
                        <img src="img/carro06.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title text-danger">Venda de Carros</h5>
                            <p class="card-text">No nosso site você encontra os melhores carros do ano.</p>
                            <a href="#" class="btn btn-success btn-lg">Compre já</a>
